...
- **[Partitions](../partitions/principe.md) + [Sortilèges](../sortileges/principe.md)** → **plus chers.** Choix structurants pour la run.
...
| Vente d'une Partition/Sortilège équipé | 50% de son prix d'achat (`SELL_REFUND_RATIO`) |
| Surplus de score | À designer (bonus selon score au-dessus de la cible ?) |
| Sortilèges | Ex : Mouches en Cascade +3 par cascade secondaire, Pourboire +3/manche, Vertige +10 si cascade profonde — voir [Sortilèges implémentés](../sortileges/sortileges-implementes.md) pour le détail à jour |
