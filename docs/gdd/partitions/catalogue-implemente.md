...
- **Line 3 retirée, Line 4 et Suite retunées (session 23)** — playtest d'une run complète en spam mono-Partition (Line 3 verticale) : aucune pression de grille, aucun recours à la Fusion, multi qui explose (voir [Questions ouvertes](../meta/questions-ouvertes.md)). Line 3 supprimée du catalogue (retirée du shop et des starters) plutôt que restreinte par direction — imposer une direction va contre la lecture naturelle de la grille par le joueur (scan toutes directions confondues), jugé mauvais pour la cognition/UX. Line 4 devient la nouvelle Partition famille-ligne la plus accessible, son multiplicateur descend ×2→×1.5 pour hériter de la niche "faible mais pas cher" de l'ancienne Line 3, tout en gardant la contrainte min 4 (un cran de plus qu'avant, donc plus exposée à la pression de grille). Suite descend ×2.5→×2 (rejoint le tier Facile) pour rétablir un écart facile/dur dans Le Prévoyant une fois réassociée à Diamond (×2.5) — voir [Structure du run](../progression/structure-run.md#choix-de-départ) pour les 4 packs day-one retravaillés en conséquence.
...
- **Générique (14)** — tiers Trivial à Medium, débloquées dès la toute première run : Line 4, Line 5, Square 4, Small T, Line 4 Rainbow, Square Rainbow, Diamond Rainbow, Brelan, Carré, Suite, Fibonacci, Minima, Prime, Diamond
