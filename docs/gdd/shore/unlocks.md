...
- **`unlock_id`** — chaque ressource gatée (Partition, pack) porte un ID technique stable et préfixé par catégorie (`sheet:`, `pack:`), séparé de son nom affiché pour survivre à un renommage. À répliquer pour Badges/Spéciaux/Grilles quand leur tour viendra.
