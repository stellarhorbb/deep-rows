## Sortilège "Un Pour Tous" : +2 mouches la premiere fois qu'une famille donnee
...
func apply(event: Dictionary, run_manager: RunManager) -> void:
	...
	var seen: Dictionary = run_manager.get_spell_state(STATE_KEY, {}) as Dictionary
	...
	run_manager.set_spell_state(STATE_KEY, seen)
