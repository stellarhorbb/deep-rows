## Badge Legendaire "Dresseur Fou" : les speciaux mobiles (Cavalier/Frog/
## Liane/Underground) ne disparaissent plus jamais. Contrairement aux autres
## Badges, son effet ne passe pas par apply() — RunContext.mobiles_
## never_expire (alimente directement depuis RunManager.has_badge dans
...
## convention que "Econome" — juste une valeur valide pour BadgeData.
