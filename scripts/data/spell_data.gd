...
## Trigger : &"on_round_start" | &"on_token_drop" | &"on_cascade_step" | &"on_turn_resolved" | &"on_last_breath" | &"on_round_end" | &"on_level_up" | &"on_deck_grown" | &"on_shake_used" | &"on_sheet_sold" | &"on_figure_promoted" | &"on_deck_tool_shown" | &"on_special_ate"
